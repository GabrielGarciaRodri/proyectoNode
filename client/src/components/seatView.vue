...
<template>
    ...
    <section class="asientos">
      <form id="myform">
        <article v-for="(row, rowIndex) in rows" :key="rowIndex" class="asientos__normal">
          <div :fila="rowIndex + 1">
            <small>{{ row.label }}</small>
            <div class="asientos__lista">
              <div v-for="(seat, seatIndex) in row.seats" :key="seatIndex">
                <input
                  type="checkbox"
                  :name="seat.value"
                  :id="seat.value"
                ...
                />
                <label :for="seat.value" :data-place="seatIndex + 1"></label>
              </div>
            </div>
          </div>
        </article>
      ...
      <button @click="buyTickets">Comprar ticket</button>
    </div>
  </template>
  <script>
export default {
      ...
      rows: [
        {
          label: 'A',
          seats: [
            { value: 'A1', status: 'available' },
            { value: 'A2', status: 'available' },
            { value: 'A3', status: 'available' },
            { value: 'A4', status: 'available' },
            { value: 'A5', status: 'available' },
          ],
        },
        {
          label: 'B',
          seats: [
            { value: 'B1', status: 'available' },
            { value: 'B2', status: 'available' },
            { value: 'B3', status: 'available' },
            { value: 'B4', status: 'available' },
            { value: 'B5', status: 'available' },
            { value: 'B6', status: 'available' },
            { value: 'B7', status: 'available' },
          ],
        },
        {
          label: 'C',
          seats: [
            { value: 'C1', status: 'available' },
            { value: 'C2', status: 'available' },
            { value: 'C3', status: 'available' },
            { value: 'C4', status: 'available' },
            { value: 'C5', status: 'available' },
            { value: 'C6', status: 'available' },
            { value: 'C7', status: 'available' },
            { value: 'C8', status: 'available' },
            { value: 'C9', status: 'available' },
          ],
        },
        {
          label: 'D',
          seats: [
            { value: 'D1', status: 'reserved' },
            { value: 'D2', status: 'reserved' },
            { value: 'D3', status: 'reserved' },
            { value: 'D4', status: 'reserved' },
            { value: 'D5', status: 'reserved' },
            { value: 'D6', status: 'reserved' },
            { value: 'D7', status: 'reserved' },
            { value: 'D8', status: 'reserved' },
            { value: 'D9', status: 'reserved' },
          ],
        },
        {
          label: 'E',
          seats: [
            { value: 'E1', status: 'reserved' },
            { value: 'E2', status: 'reserved' },
            { value: 'E3', status: 'reserved' },
            { value: 'E4', status: 'reserved' },
            { value: 'E5', status: 'reserved' },
            { value: 'E6', status: 'reserved' },
            { value: 'E7', status: 'reserved' },
            { value: 'E8', status: 'reserved' },
            { value: 'E9', status: 'reserved' },
                      ],
        },
        {
          label: 'F',
          seats: [
            { value: 'F1', status: 'reserved' },
            { value: 'F2', status: 'reserved' },
            { value: 'F3', status: 'reserved' },
            { value: 'F4', status: 'reserved' },
            { value: 'F5', status: 'reserved' },
            { value: 'F6', status: 'reserved' },
            { value: 'F7', status: 'reserved' },
            { value: 'F8', status: 'reserved' },
            { value: 'F9', status: 'reserved' },
          ],
        },
      ],
      totalPrice: 0
...
<style>
  ...
  .seat-view {
    ...
    color: #fff; /* Ajusta según el color principal de tu diseño */
  ...
  .reserved {
    background-color: #f44336; /* Rojo para asientos reservados */
  }
  
  .selected {
    background-color: #2196F3; /* Azul para asientos seleccionados */
  }
